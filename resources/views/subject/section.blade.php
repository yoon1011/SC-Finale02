...
@section('main-content')
	...
	<div class="container-fluid spark-screen">
		<div class="row">
            ...
            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#sec">Manage section</button>
					</div>
					<div class="box-body">
						<h4>Sections</h4>
						<div class="tab">
...
<div class="modal fade" id="sec">
  <div class="modal-dialog">
    <form method="post" action="{{action('HomeController@remremak', $subject->id)}}">
      {{csrf_field()}}
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
